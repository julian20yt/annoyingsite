...
const SEARCHES = [
  'where should i get nexus s 4g',
  'why does my youtube twitch',
  'jerrys bait shop',
  'chicken',
  'free cocaine',
  'how to get free nexus s 4g',
  '102.7 webn',
  'nexus s 4g cats',
  'dr. jr. stroke',
  'catdog theme song',
...
const VIDEOS = [
  'https://www.albinoblacksheep.com/mp4/albuquerque(www.albinoblacksheep.com).mp4'
]

const FILE_DOWNLOADS = [
  'https://i.pinimg.com/736x/bf/21/de/bf21deeef128ed67160f9fddd520036b.jpg',
  'https://spencers.scene7.com/is/image/Spencers/01764653-a?wid=640&hei=640&fmt=webp'
]
